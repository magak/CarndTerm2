...
void PID::Init(double Kp, double Kd, double Ki) {
	...
	p_[0] = 0.551854;//Kp;
	p_[1] = 300.217;//Kd;
	p_[2] = 0.000630887;//Ki;dp1=0.00430278 dp2=1.05614 dp3=2.38047e-06

	dp_[0] = 0.00430278;//p_[0]/3;
	dp_[1] = 1.05614;//p_[1]/2;
	dp_[2] = 2.38047e-06;//p_[2]/2;


	dp1=0.000120085 dp2=0.0022238 dp3=1.09168e-07
	p1=0.375 p2=6.24778 p3=0.0003
	*/
